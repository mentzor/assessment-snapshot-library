...
const ASSESSMENTS = [
  ...
  },
  {
    ...
    admin: "Self-Report",
    time: "20–30 min",
    publisher: "The Myers-Briggs Company (CPP)",
    overview:
      "The world's most widely used personality assessment, based on Carl Jung's theory of psychological types. Categorizes individuals into 16 personality types using four dichotomies: Extraversion/Introversion, Sensing/Intuition, Thinking/Feeling, Judging/Perceiving. Extremely popular in organizational development, career counseling, and team building despite ongoing psychometric debates.",
    psychometrics: {
      reliability: "Test-retest consistency 75-90% for type; internal consistency moderate for scales",
      validity: "Predictive validity debated; correlates with Big Five; face validity high; criterion validity mixed",
      normSample: "Over 3 million individuals tested; diverse occupational and demographic samples",
      standardization: "Categorical types (16 types); continuous preference scores also available",
    },
    scales: [
      { name: "Extraversion-Introversion (E-I)", abbr: "E-I", mean: 50, sd: 10, min: 0, max: 100, type: "dimension" },
      { name: "Sensing-Intuition (S-N)", abbr: "S-N", mean: 50, sd: 10, min: 0, max: 100, type: "dimension" },
      { name: "Thinking-Feeling (T-F)", abbr: "T-F", mean: 50, sd: 10, min: 0, max: 100, type: "dimension" },
      { name: "Judging-Perceiving (J-P)", abbr: "J-P", mean: 50, sd: 10, min: 0, max: 100, type: "dimension" },
    ],
    interpretRanges: [
      { label: "Clear Preference (Left Pole)", min: 0, max: 35, color: "#dc2626", desc: "Strong preference for E, S, T, or J. Clear and consistent use of this function." },
      { label: "Moderate Preference (Left)", min: 36, max: 45, color: "#ea580c", desc: "Moderate preference for left pole. Generally favors this but some flexibility." },
      { label: "Slight/No Clear Preference", min: 46, max: 54, color: "#16a34a", desc: "Midpoint. May use both functions depending on context. Type may be less clear." },
      { label: "Moderate Preference (Right)", min: 55, max: 64, color: "#0891b2", desc: "Moderate preference for right pole (I, N, F, or P). Generally favors this function." },
      { label: "Clear Preference (Right Pole)", min: 65, max: 100, color: "#7c3aed", desc: "Strong preference for I, N, F, or P. Clear and consistent use of this function." },
    ],
    caseStudies: [
      {
        name: "ENTJ - 'The Commander'",
        scores: { "E-I": 72, "S-N": 68, "T-F": 75, "J-P": 70 },
        narrative: "A 38-year-old executive director. Strong preferences for E, N, T, J — the 'Commander' type. Natural leader who thinks strategically, makes decisions logically, and prefers structure. Common in leadership and management roles. May need to develop awareness of others' feelings.",
      },
      {
        name: "INFP - 'The Mediator'",
        scores: { "E-I": 28, "S-N": 32, "T-F": 25, "J-P": 30 },
        narrative: "A 26-year-old writer and counselor-in-training. Strong preferences for I, N, F, P — the 'Mediator' type. Values-driven, idealistic, seeks meaning and authenticity. Prefers flexibility over rigid structure. Common in helping professions and creative fields.",
      },
      {
        name: "ISTJ - 'The Logistician'",
        scores: { "E-I": 30, "S-N": 70, "T-F": 68, "J-P": 72 },
        narrative: "A 45-year-old accountant. Strong I, S, T, J preferences — the 'Logistician' type. Practical, detail-oriented, responsible, values tradition and order. Excellent with systems and procedures. Most common type in general population (~13%).",
      },
    ],
    keyFacts: [
      "Based on Carl Jung's theory of psychological types (1921)",
      "16 types result from combinations of 4 dichotomies: e.g., INTJ, ESFP, ENFJ",
      "Most popular in organizational/career contexts — less used in clinical psychology",
      "Criticized for forced-choice dichotomies (trait psychology suggests continuums)",
      "Type stability debated — 25-50% change type on retest depending on study",
      "Not designed to measure psychopathology or predict job performance",
      "Strong face validity and user acceptance despite psychometric limitations",
      "Should NOT be used for hiring decisions or clinical diagnosis",
    ],
  },
  ...
  },
  {
    ...
    admin: "Individual, Clinician",
    time: "60–90 min",
    publisher: "Harvard University Press (Public Domain)",
    overview:
      "A classic projective technique using ambiguous pictures to elicit narratives revealing personality dynamics, interpersonal themes, motivations, and unconscious conflicts. The person creates stories about 8-12 cards selected from a set of 31. Widely used in clinical, forensic, and cross-cultural research despite lack of standardized scoring.",
    psychometrics: {
      reliability: "Variable depending on scoring system; thematic consistency .60–.80",
      validity: "Extensive clinical validation; sensitive to depression, aggression, achievement motivation",
      normSample: "No standardized norms; interpretive guidelines based on clinical experience",
      standardization: "Qualitative interpretation; various scoring systems exist (e.g., Defense Mechanisms Manual, Social Cognition and Object Relations Scale)",
    },
    scales: [
      { name: "Achievement Motivation", abbr: "nAch", mean: null, sd: null, min: 0, max: 10, type: "theme", rawScore: true },
      { name: "Affiliation Needs", abbr: "nAff", mean: null, sd: null, min: 0, max: 10, type: "theme", rawScore: true },
      { name: "Power/Dominance", abbr: "nPow", mean: null, sd: null, min: 0, max: 10, type: "theme", rawScore: true },
      { name: "Aggression Themes", abbr: "Agg", mean: null, sd: null, min: 0, max: 10, type: "theme", rawScore: true },
      { name: "Depressive Themes", abbr: "Dep", mean: null, sd: null, min: 0, max: 10, type: "theme", rawScore: true },
    ],
    interpretRanges: [
      { label: "Minimal/Absent", min: 0, max: 2, color: "#16a34a", desc: "Theme rarely or never appears in stories. Not a significant concern." },
      { label: "Moderate Presence", min: 3, max: 5, color: "#ca8a04", desc: "Theme appears with moderate frequency. May be clinically relevant." },
      { label: "Strong Presence", min: 6, max: 10, color: "#dc2626", desc: "Theme dominates narratives. Likely reflects significant psychological concern or preoccupation." },
    ],
    caseStudies: [
      {
        name: "Depression with Low Self-Esteem",
        scores: { nAch: 2, nAff: 7, nPow: 1, Agg: 3, Dep: 8 },
        narrative: "A 35-year-old with major depression. Stories characterized by themes of loss, failure, hopelessness, and interpersonal rejection. High affiliation needs with depressive themes suggest dependency and fear of abandonment. Low achievement motivation reflects demoralization.",
      },
      {
        name: "Achievement-Oriented Professional",
        scores: { nAch: 9, nAff: 4, nPow: 7, Agg: 2, Dep: 1 },
        narrative: "A 42-year-old executive in career counseling. Stories emphasize goal-directed behavior, competition, and influence over others. High achievement and power needs with low affiliation — classic 'Type A' profile focused on success over relationships.",
      },
    ],
    keyFacts: [
      "Developed by Henry Murray at Harvard in 1935 based on psychoanalytic theory",
      "No standardized administration — clinician selects 8-12 cards from 31 based on age, gender, presenting problem",
      "Originally designed to assess unconscious needs and conflicts (nAchievement, nAffiliation, nPower)",
      "Interpretation is highly qualitative and depends heavily on clinician expertise",
      "More research support than most projectives, especially for achievement motivation and depression",
      "Cross-cultural applications are extensive but require cultural sensitivity in interpretation",
      "Often combined with Rorschach in projective test batteries",
    ],
  },
  {
    id: "htp",
    name: "HTP",
    fullName: "House-Tree-Person Test",
    domain: "Personality",
    domainColor: "#7c3aed",
    year: 1948,
    ages: "3+",
    ...
    overview:
      "A projective drawing technique where individuals draw a house, tree, and person, then answer questions about their drawings. Used to assess personality characteristics, emotional functioning, and self-concept, particularly with children and individuals with limited verbal skills. Popular in school and clinical settings despite limited psychometric support.",
    psychometrics: {
      reliability: "Inter-rater reliability varies widely (.50–.85 depending on scoring system and training)",
      validity: "Limited empirical validity; clinical utility debated; some research supports use with trauma and abuse",
      normSample: "No standardized norms; developmental guidelines available by age",
      standardization: "Qualitative interpretation using various scoring systems (Buck, Hammer, Jolles)",
    },
    scales: [
      { name: "Emotional Indicators", abbr: "EI", mean: null, sd: null, min: 0, max: 20, type: "qualitative", rawScore: true },
      { name: "Self-Esteem Indicators", abbr: "SE", mean: null, sd: null, min: 0, max: 15, type: "qualitative", rawScore: true },
      { name: "Interpersonal Issues", abbr: "IP", mean: null, sd: null, min: 0, max: 15, type: "qualitative", rawScore: true },
      { name: "Anxiety/Insecurity", abbr: "Anx", mean: null, sd: null, min: 0, max: 15, type: "qualitative", rawScore: true },
    ],
    interpretRanges: [
      { label: "Few Concerns", min: 0, max: 3, color: "#16a34a", desc: "Minimal indicators of emotional distress or psychological concerns." },
      { label: "Some Concerns", min: 4, max: 7, color: "#ca8a04", desc: "Moderate number of indicators. Warrants clinical attention and follow-up." },
      { label: "Significant Concerns", min: 8, max: 30, color: "#dc2626", desc: "Multiple indicators present. Suggests significant emotional distress or psychopathology." },
    ],
    caseStudies: [
      {
        name: "Child Abuse Evaluation",
        scores: { EI: 12, SE: 9, IP: 8, Anx: 11 },
        narrative: "An 8-year-old referred for suspected abuse. Drawings show multiple trauma indicators: tiny figures, excessive shading, omission of body parts, house with no door. Combined with other assessment data, supports concerns about maltreatment and need for protection.",
      },
      {
        name: "Low Self-Esteem Profile",
        scores: { EI: 7, SE: 10, IP: 5, Anx: 8 },
        narrative: "A 14-year-old with depression. Person drawing is tiny, placed at bottom of page with slumped posture and no facial features. Tree has broken branches. Multiple indicators of poor self-concept and feelings of inadequacy.",
      },
    ],
    keyFacts: [
      "Developed by John Buck in 1948; updated by Emanuel Hammer and others",
      "Three drawings symbolize: House (family/home relationships), Tree (life history/growth), Person (self-concept)",
      "Post-Drawing Interrogation (PDI) asks specific questions about each drawing for additional data",
      "Popular with children, individuals with language barriers, or cognitive limitations",
      "Chromatic (color) version available; some clinicians prefer pencil-only for consistency",
      "Scientific support is limited — use cautiously and never as sole diagnostic tool",
      "Best used as supplementary clinical data or rapport-building technique, not standalone assessment",
      "Particularly useful for detecting trauma, abuse, or severe emotional disturbance in children",
    ],
  },
  ...
  // ── ADAPTIVE FUNCTIONING ──────────────────────────────────────────────────
  {
    ...
    year: 2016,
    ages: "0–90",
    admin: "Interview or Rating Form",
    time: "20–60 min",
    publisher: "Pearson",
    overview:
      "The gold-standard assessment of adaptive behavior from birth through adulthood. Measures everyday living skills across Communication, Daily Living Skills, and Socialization domains. Essential for diagnosing intellectual disability, autism spectrum disorder, and developmental delays. Used extensively in schools, clinics, and disability determinations.",
    psychometrics: {
      reliability: "Domain internal consistency α = .91–.98; ABC α = .97–.98",
      validity: "Strong correlations with other adaptive measures; discriminates clinical from typical development",
      normSample: "3,695 individuals stratified by age, sex, race/ethnicity, education, geographic region",
      standardization: "Standard scores (M=100, SD=15) for domains and ABC; v-scale scores (M=15, SD=3) for subdomains",
    },
    scales: [
      { name: "Adaptive Behavior Composite (ABC)", abbr: "ABC", mean: 100, sd: 15, min: 20, max: 160, type: "composite" },
      { name: "Communication Domain", abbr: "COM", mean: 100, sd: 15, min: 20, max: 160, type: "domain" },
      { name: "Daily Living Skills Domain", abbr: "DLS", mean: 100, sd: 15, min: 20, max: 160, type: "domain" },
      { name: "Socialization Domain", abbr: "SOC", mean: 100, sd: 15, min: 20, max: 160, type: "domain" },
      { name: "Motor Skills Domain", abbr: "MOT", mean: 100, sd: 15, min: 20, max: 160, type: "domain" },
    ],
    interpretRanges: [
      { label: "Low", min: 20, max: 70, color: "#dc2626", desc: "Significantly below average. ≤2 SD below mean. Consistent with intellectual disability when paired with low IQ." },
      { label: "Moderately Low", min: 71, max: 85, color: "#ea580c", desc: "1-2 SD below mean. Mild adaptive deficits; may need supports in some areas." },
      { label: "Adequate", min: 86, max: 115, color: "#16a34a", desc: "Within normal limits. Age-appropriate adaptive functioning." },
      { label: "Moderately High", min: 116, max: 130, color: "#0891b2", desc: "Above average adaptive skills. 1-2 SD above mean." },
      { label: "High", min: 131, max: 160, color: "#7c3aed", desc: "Well above average. >2 SD above mean. Exceptional adaptive functioning." },
    ],
    caseStudies: [
      {
        name: "Intellectual Disability Diagnosis",
        scores: { ABC: 58, COM: 62, DLS: 55, SOC: 60, MOT: 65 },
        narrative: "A 12-year-old referred for ID evaluation. All domains in Low range (>2 SD below mean) with consistent pattern of deficits. When paired with FSIQ of 64 on WISC-V, meets criteria for mild intellectual disability.",
      },
      {
        name: "Autism Spectrum Profile",
        scores: { ABC: 72, COM: 68, DLS: 85, SOC: 58, MOT: 78 },
        narrative: "An 8-year-old with ASD diagnosis. ABC in Moderately Low range with marked scatter. Socialization severely depressed (classic ASD pattern) while Daily Living Skills relatively stronger. Communication also impaired.",
      },
      {
        name: "Developmental Delay",
        scores: { ABC: 78, COM: 75, DLS: 80, SOC: 82, MOT: 70 },
        narrative: "A 4-year-old with global developmental delay. All domains 1-2 SD below mean with Motor Skills most affected. Qualifies for early intervention services. Pattern suggests need for OT/PT and speech therapy.",
      },
    ],
    keyFacts: [
      "Required for intellectual disability diagnosis per DSM-5 and AAIDD criteria",
      "Adaptive behavior deficits must onset during developmental period (before age 18)",
      "Interview format (gold standard) takes 20-60 min; parent/teacher rating forms are faster",
      "ABC ≤70 + IQ ≤70 + onset before 18 = intellectual disability diagnostic criteria met",
      "Particularly sensitive to ASD — often shows Communication/Socialization < Daily Living Skills",
      "Can be administered repeatedly to track progress with intervention",
      "Age equivalents help identify specific skill gaps for intervention planning",
    ],
  },
  {
    id: "abas3",
    ...
    year: 2015,
    ages: "0–89",
    admin: "Rating Scale (Parent/Teacher/Self)",
    time: "15–20 min",
    publisher: "Pearson / Western Psychological Services",
    overview:
      "A comprehensive norm-referenced rating scale assessing adaptive skills across the lifespan. Offers multiple rater forms (parent, teacher, self-report) making it ideal for gathering information from multiple perspectives. Widely used in schools for special education eligibility and in clinical settings for developmental disabilities assessment.",
    psychometrics: {
      reliability: "Internal consistency α = .97–.99 for GAC; test-retest r = .90–.97",
      validity: "Strong convergent validity with Vineland-3 (r = .70–.82); discriminates ID from typical development",
      normSample: "6,000+ individuals across all age ranges; stratified by US Census demographics",
      standardization: "Standard scores (M=100, SD=15) for skill areas and GAC",
    },
    scales: [
      { name: "General Adaptive Composite (GAC)", abbr: "GAC", mean: 100, sd: 15, min: 40, max: 160, type: "composite" },
      { name: "Conceptual Skills", abbr: "CON", mean: 100, sd: 15, min: 40, max: 160, type: "domain" },
      { name: "Social Skills", abbr: "SOC", mean: 100, sd: 15, min: 40, max: 160, type: "domain" },
      { name: "Practical Skills", abbr: "PRA", mean: 100, sd: 15, min: 40, max: 160, type: "domain" },
    ],
    interpretRanges: [
      { label: "Extremely Low", min: 40, max: 70, color: "#dc2626", desc: "≥2 SD below mean. Significant adaptive deficits consistent with intellectual disability." },
      { label: "Borderline", min: 71, max: 79, color: "#ea580c", desc: "1-2 SD below mean. Mild to moderate adaptive limitations." },
      { label: "Below Average", min: 80, max: 89, color: "#ca8a04", desc: "Slightly below average. May need some support." },
      { label: "Average", min: 90, max: 109, color: "#16a34a", desc: "Within normal limits. Age-appropriate adaptive functioning." },
      { label: "Above Average", min: 110, max: 119, color: "#0891b2", desc: "Above average adaptive skills." },
      { label: "Superior", min: 120, max: 129, color: "#7c3aed", desc: "Well above average adaptive functioning." },
      { label: "Very Superior", min: 130, max: 160, color: "#be185d", desc: ">2 SD above mean. Exceptional adaptive skills." },
    ],
    caseStudies: [
      {
        name: "School-Based ID Evaluation",
        scores: { GAC: 64, CON: 62, SOC: 68, PRA: 66 },
        narrative: "A 10-year-old evaluated for special education. Parent and teacher ratings both show GAC in Extremely Low range across all skill areas. Combined with WISC-V FSIQ of 67, meets criteria for intellectual disability and qualifies for services.",
      },
      {
        name: "Multi-Rater Discrepancy",
        scores: { GAC: 88, CON: 92, SOC: 78, PRA: 90 },
        narrative: "A 7-year-old with ADHD. Parent ratings show below average adaptive functioning, especially in Social domain. However, teacher ratings show Average range performance. Discrepancy suggests context-dependent difficulties — child struggles more in unstructured social settings than structured classroom.",
      },
    ],
    keyFacts: [
      "ABAS-3 aligns with AAIDD's three-domain conceptualization of adaptive behavior",
      "Multiple rater forms allow cross-informant comparison (parent vs. teacher vs. self)",
      "Self-report form available for ages 16-89, useful for adult assessments",
      "Rating scale format is faster than interview (Vineland) but may be less reliable",
      "Particularly useful in school settings where teacher input is critical",
      "Can be completed by respondent independently or via structured interview",
    ],
  },
  {
    id: "abes",
    name: "ABES-3",
    fullName: "Adaptive Behavior Evaluation Scale, Third Edition",
    domain: "Adaptive",
    domainColor: "#dc2626",
    year: 2013,
    ages: "4–18 (school-age)",
    admin: "Rating Scale (Parent/Teacher)",
    time: "15–20 min",
    publisher: "Hawthorne Educational Services",
    overview:
      "A behaviorally-anchored rating scale designed specifically for school-age children and adolescents. Focuses on adaptive skills relevant to educational settings. Particularly useful for RTI/MTSS frameworks and monitoring progress in special education. Provides intervention recommendations based on results.",
    psychometrics: {
      reliability: "Internal consistency α = .95–.98; test-retest r = .89–.94",
      validity: "Content validity established through expert review; criterion validity with ABAS and Vineland",
      normSample: "3,000+ students ages 4-18; nationally representative sample",
      standardization: "Standard scores (M=100, SD=15) and quotients",
    },
    scales: [
      { name: "Adaptive Behavior Quotient (ABQ)", abbr: "ABQ", mean: 100, sd: 15, min: 55, max: 145, type: "composite" },
      { name: "Communication", abbr: "COM", mean: 100, sd: 15, min: 55, max: 145, type: "domain" },
      { name: "Self-Care", abbr: "SC", mean: 100, sd: 15, min: 55, max: 145, type: "domain" },
      { name: "Home Living", abbr: "HL", mean: 100, sd: 15, min: 55, max: 145, type: "domain" },
      { name: "Social", abbr: "SOC", mean: 100, sd: 15, min: 55, max: 145, type: "domain" },
      { name: "Community Use", abbr: "CU", mean: 100, sd: 15, min: 55, max: 145, type: "domain" },
      { name: "Self-Direction", abbr: "SD", mean: 100, sd: 15, min: 55, max: 145, type: "domain" },
    ],
    interpretRanges: [
      { label: "Very Poor", min: 55, max: 70, color: "#dc2626", desc: "≥2 SD below mean. Severe adaptive deficits requiring intensive support." },
      { label: "Poor", min: 71, max: 79, color: "#ea580c", desc: "1-2 SD below mean. Significant adaptive limitations." },
      { label: "Below Average", min: 80, max: 89, color: "#ca8a04", desc: "Mildly below average. May benefit from targeted interventions." },
      { label: "Average", min: 90, max: 110, color: "#16a34a", desc: "Within normal limits for age and grade." },
      { label: "Above Average", min: 111, max: 120, color: "#0891b2", desc: "Above average adaptive skills." },
      { label: "Superior", min: 121, max: 145, color: "#7c3aed", desc: "Well above average. Exceptional adaptive functioning." },
    ],
    caseStudies: [
      {
        name: "Special Education Eligibility",
        scores: { ABQ: 68, COM: 72, SC: 70, HL: 65, SOC: 66, CU: 64, SD: 70 },
        narrative: "A 9-year-old referred for special education evaluation. Teacher ratings show ABQ in Very Poor range with consistent deficits across all domains. Qualifies for adaptive behavior support services in special education program.",
      },
      {
        name: "RTI Progress Monitoring",
        scores: { ABQ: 85, COM: 90, SC: 88, HL: 82, SOC: 78, SOC: 80, SD: 84 },
        narrative: "A 12-year-old receiving Tier 2 interventions. ABES-3 administered quarterly shows gradual improvement in Social and Self-Direction domains. Progress monitoring indicates interventions are effective; continued support recommended.",
      },
    ],
    keyFacts: [
      "Designed specifically for school contexts — includes educationally-relevant behaviors",
      "Provides specific intervention goals and strategies based on item-level analysis",
      "Home and School versions allow comparison across settings",
      "Particularly useful in RTI/MTSS frameworks for progress monitoring",
      "Shorter and more focused than Vineland or ABAS — quicker screening option",
      "Rating scale uses behaviorally-anchored descriptors for more reliable ratings",
    ],
  },
  {
    id: "dabs",
    name: "DABS",
    fullName: "Diagnostic Adaptive Behavior Scale",
    domain: "Adaptive",
    domainColor: "#dc2626",
    year: 2013,
    ages: "4–21",
    admin: "Structured Interview",
    time: "20–30 min",
    publisher: "AAIDD",
    overview:
      "Developed specifically for diagnosing intellectual disability according to AAIDD diagnostic criteria. The only adaptive measure created explicitly to support ID diagnosis. Assesses adaptive behavior across Conceptual, Social, and Practical domains with particular sensitivity to mild ID. Endorsed by AAIDD as best practice for ID diagnosis.",
    psychometrics: {
      reliability: "Internal consistency α = .96–.98; inter-rater reliability ICC = .90",
      validity: "Criterion validity with Vineland-II (r = .81); excellent sensitivity/specificity for ID diagnosis",
      normSample: "2,000+ individuals ages 4-21; includes clinical samples with ID",
      standardization: "Standard scores (M=100, SD=15); diagnostic cutoff scores established",
    },
    scales: [
      { name: "General Adaptive Composite (GAC)", abbr: "GAC", mean: 100, sd: 15, min: 40, max: 160, type: "composite" },
      { name: "Conceptual Domain", abbr: "CON", mean: 100, sd: 15, min: 40, max: 160, type: "domain" },
      { name: "Social Domain", abbr: "SOC", mean: 100, sd: 15, min: 40, max: 160, type: "domain" },
      { name: "Practical Domain", abbr: "PRA", mean: 100, sd: 15, min: 40, max: 160, type: "domain" },
    ],
    interpretRanges: [
      { label: "Significant Limitation", min: 40, max: 75, color: "#dc2626", desc: "≥1.5 SD below mean. Meets AAIDD criterion for significant adaptive limitation (diagnostic threshold for ID)." },
      { label: "Below Average", min: 76, max: 89, color: "#ea580c", desc: "Mildly below average but above diagnostic threshold." },
      { label: "Average", min: 90, max: 110, color: "#16a34a", desc: "Within normal limits. No adaptive deficit." },
      { label: "Above Average", min: 111, max: 124, color: "#0891b2", desc: "Above average adaptive functioning." },
      { label: "Superior", min: 125, max: 160, color: "#7c3aed", desc: "Well above average adaptive skills." },
    ],
    caseStudies: [
      {
        name: "Mild ID Diagnosis",
        scores: { GAC: 72, CON: 70, SOC: 75, PRA: 73 },
        narrative: "A 16-year-old evaluated for ID diagnosis. DABS GAC of 72 falls below diagnostic cutoff of 75. All three domains show significant limitations. Combined with WAIS-IV FSIQ of 68, meets full AAIDD criteria for mild intellectual disability diagnosis.",
      },
      {
        name: "Borderline Intellectual Functioning",
        scores: { GAC: 78, CON: 76, SOC: 82, PRA: 77 },
        narrative: "An 18-year-old with FSIQ of 74. DABS GAC of 78 is just above diagnostic cutoff (75), despite IQ in ID range. Per AAIDD criteria, does NOT meet criteria for ID diagnosis — classified as Borderline Intellectual Functioning instead. Demonstrates importance of adaptive assessment.",
      },
      {
        name: "Rule-Out ID in ASD",
        scores: { GAC: 88, CON: 85, SOC: 68, PRA: 95 },
        narrative: "A 10-year-old with ASD and FSIQ of 72. DABS shows Social domain deficit but GAC above diagnostic threshold. Social deficits attributed to ASD, not global adaptive impairment. Does not meet criteria for comorbid ID — ASD diagnosis only.",
      },
    ],
    keyFacts: [
      "ONLY measure specifically designed to diagnose intellectual disability per AAIDD criteria",
      "Uses 1.5 SD cutoff (standard score ≤75) rather than traditional 2 SD — more sensitive to mild ID",
      "AAIDD's official diagnostic tool — considered best practice for ID diagnosis",
      "Structured interview format reduces rater bias compared to rating scales",
      "Particularly good at discriminating mild ID from borderline intellectual functioning",
      "Normed on both typical and ID populations for better diagnostic accuracy",
      "Must show deficits in adaptive behavior AND IQ ≤70 for ID diagnosis",
    ],
  },
];
...
const DOMAINS = ["All", "Intelligence", "Personality", "Clinical", "Neuropsychological", "Vocational", "Adaptive"];
const DOMAIN_COLORS = {
  Intelligence: "#2563eb",
  Personality: "#7c3aed",
  Clinical: "#0891b2",
